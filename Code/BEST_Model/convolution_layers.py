...
def conv2d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, regularize=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
...
def transpose_conv2d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, add_bias=True, regularize=True, drop_rate=0.0, batch_norm=BATCH_NORM,training=True, name=None, reuse=None):
...
# http://arxiv.org/abs/1512.00567
def transpose_inception_v3(x, n_out, stride=1, activation=ACTIVATION, regularize=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
...
def resnet(x, n_out, kernel_size, activation=ACTIVATION, regularize=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
...
# Define Convolutional Layer [1 dimensional]
#def conv2d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, regularize=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
def conv1d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, regularize=True, use_bias=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
...
# Define Convolution Transpose Layer
def transpose_conv1d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, regularize=True, use_bias=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
...
# Define Convolutional Layer [1 dimensional]
def dense1d_layer(x, n_out, activation=ACTIVATION, regularize=True, use_bias=True, drop_rate=0.0, batch_norm=BATCH_NORM, training=True, name=None, reuse=None):
