...
def conv2d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, add_bias=True, regularize=True, drop_rate=0.0, batch_norm=False, training=True, name=None, reuse=None):
...
def transpose_conv2d_layer(x, n_out, kernel_size, stride=1, activation=ACTIVATION, add_bias=True, regularize=True, drop_rate=0.0, batch_norm=False,training=True, name=None, reuse=None):
    ...
    #wt_init = tf.truncated_normal_initializer(stddev=0.1)
    wt_init = tf.truncated_normal_initializer(stddev=0.3)
    bi_init = tf.truncated_normal_initializer(mean=BIAS_SHIFT,stddev=0.01)
...
def inception_v3(x, n_out, stride=1, activation=ACTIVATION, add_bias=True, regularize=True, drop_rate=0.0, batch_norm=False, training=True, name=None, reuse=None):
    ...
    y1 = conv2d_layer(x, n_out//4, 1, stride=1, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)

    if name:  name = base_name + '_1b'
    y1 = conv2d_layer(y1, n_out//4, 3, stride=stride, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)
    ...
    y2 = conv2d_layer(x, n_out//4, 1, stride=1, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)

    if name:  name = base_name + '_2b'
    y2 = conv2d_layer(y2, n_out//4, 3, stride=1, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)

    if name:  name = base_name + '_2c'
    y2 = conv2d_layer(y2, n_out//4, 3, stride=stride, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)
    ...
    y3 = conv2d_layer(y3, n_out//4, 1, stride=1, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)
    ...
    y4 = conv2d_layer(x, n_out//4, 1, stride=stride, activation=activation, add_bias=add_bias, regularize=regularize,
                      drop_rate=drop_rate, batch_norm=batch_norm, training=training, name=name, reuse=reuse)
